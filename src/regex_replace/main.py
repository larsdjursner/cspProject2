...
def regex_replace(testcases):
    ...
    plot("regex_replace", "Size", "Time in ms", results, "regex_replace_time.png")
    ...
    plot("regex_replace", "Size", "Throughput in bytes/ms", [("pandas", pandas_size, pd_throughput), ("cudf", cudf_size, cu_throughput)], "regex_replace_throughput.png")
